class Game {
    constructor(images, sounds){
        ...
        this.started = false
        this.over = false
        this.hero = new Mario(this.coinImages, {x: gameSettings.heroStartX, y: gameSettings.heroStartY}, gameSettings.heroSize)
        this.coins = Array.from({ length: gameSettings.numCoins}, (el, i) => {
            return new Coin(this.marioImages, { x: gameSettings.coinSize + gameSettings.coinSize * i, y: gameSettings.coinLevel }, gameSettings.coinSize)
        })
    ...
    init = () => {
        if(!this.started){
            ...
            this.hero = new Mario(this.coinImages, this.sounds.jumpSound, {x: gameSettings.heroStartX, y: gameSettings.heroStartY}, gameSettings.heroSize)
            this.started = true
